...
@Component({
  ...
  styleUrls: ['./collapsable-navigation.component.css'],
  animations: [
...
export class CollapsableNavigationComponent {
  ...
  // private _navbarNavigationComponent: NavBarNavigationComponent;
  ...
  ngOnInit(): void {
    ...
    // this._navbarNavigationComponent = this._fuseNavigationService.getComponent(this.name);
    ...
    // this._navbarNavigationComponent.onCollapsableItemCollapsed
    ...
    // if (this.autoCollapse) {
    // this._navbarNavigationComponent.onCollapsableItemExpanded
    //   .pipe(takeUntil(this._unsubscribeAll))
    ...
    // this._navbarNavigationComponent.onRefreshed.pipe(
    //   takeUntil(this._unsubscribeAll)
    // ).subscribe(() => {
  ...
  collapse(): void {
    ...
    // this._navbarNavigationComponent.onCollapsableItemCollapsed.next(this.item);
  }
  ...
  expand(): void {
    ...
    //cambiar el sentido de la flecha
    ...
    // Execute the observable
    // this._navbarNavigationComponent.onCollapsableItemExpanded.next(this.item);
  }
